...
print(type(AVIATION_STACK_API_KEY))
print(type(OPENWEATHER_API_KEY))
print(type(TAVILY_API_KEY))
...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            "transport": "stdio",
            "command": "/Users/kartik/Documents/Travel_Planner_Multi_Agent_MCP_Server/aviationstack-mcp/.venv/bin/python",
            "args": [
                "-m",
                "aviationstack_mcp",
                "mcp",
        ...
        "weather": {
            "transport": "stdio",
            "command": "/Users/kartik/Documents/Travel_Planner_Multi_Agent/venv/bin/python",
            "args": [
                 "/Users/kartik/Documents/Travel_Planner_Multi_Agent_MCP_Server/custom_weather_mcp_server.py"
            ],
            "env": {
